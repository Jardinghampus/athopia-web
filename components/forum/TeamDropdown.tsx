      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-2 z-50 origin-top-right w-52 rounded-2xl border border-border/60 bg-popover shadow-lg shadow-black/30 overflow-hidden"
          >
