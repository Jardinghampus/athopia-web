...
export default function IntegritetspolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <h1 className="font-heading text-4xl text-foreground mb-6">Integritetspolicy</h1>
      <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground leading-relaxed">
        ...
        <section>
          <h2 className="font-heading text-2xl text-foreground mb-3">Vilka uppgifter samlar vi in?</h2>
        ...
        <section>
          <h2 className="font-heading text-2xl text-foreground mb-3">Hur använder vi uppgifterna?</h2>
          <ul className="list-disc list-inside space-y-1">
        ...
        <section>
          <h2 className="font-heading text-2xl text-foreground mb-3">Dina rättigheter</h2>
          <p>
        ...
        <section>
          <h2 className="font-heading text-2xl text-foreground mb-3">Cookies</h2>
          <p>
