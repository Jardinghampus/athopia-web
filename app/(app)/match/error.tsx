...
/**
 * Matchsidorna blandar server-hämtad data med tunga klientkomponenter
 * (LiveMatchClient, MatchForum, PlayerRatingPanel) — ett fel här ska inte
 * dra ner hela produktytan, bara matchvyn.
 */
export default function MatchError({
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center gap-4 px-5 py-24 text-center">
      ...
      <h1 className="text-xl font-semibold text-balance text-foreground">Matchen kunde inte visas</h1>
      <p className="text-sm text-muted-foreground">
        Vi loggade felet. Försök igen, eller se alla matcher under tiden.
      </p>
